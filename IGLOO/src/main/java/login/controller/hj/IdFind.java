...
public class IdFind extends AbstractController {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		if("POST".equalsIgnoreCase(method)) {
			...
			if(userid != null) {
				request.setAttribute("userid", "<span style='font-size:30pt; font-weight: bold;'>ID : </span>" 
												+ "<span style='font-size:30pt; font-weight: bold; color: blue;'>" + userid + "</span>" 
												+ "<span style='font-size:30pt; font-weight: bold;'> 입니다.</span>");
			}
			else {
				request.setAttribute("userid", "<span style='color: red; font-size: 30pt; font-weight: bold'>해당정보의 아이디가 존재하지 않습니다.</span>");
			}	// end of if~else-----------
