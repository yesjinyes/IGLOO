...
<body>
	<div id="hongdae" class="mx-auto mt-3">
		<div class="representative">
			<img src="<%=ctxPath%>/images/img_hj/store/igloo_bupyeong.jpg" alt="...">
		</div>
		...
		<div class="details_location mt-5">
        	<div data-viewid="basicInfoTitle" data-root="" class="place_details" style="display: block;">
    			...
    			<h2 class="tit_location mt-2 mb-3">이글루 부평점</h2>
    			...
    			<div class="details_contactinfo">
        			...
        			<ul class="list_infolocation row">
                		<li class="col-4">
		                    ...
		                    <span>주소 : 인천 부평구 경원대로1403번길 4</span>
                		</li>
                		<li class="col-4">
		                	<i class="fa-solid fa-phone"></i>
		                    <span>전화번호 : 032-222-2222</span>
                		</li>
            			<li class="col-4">
