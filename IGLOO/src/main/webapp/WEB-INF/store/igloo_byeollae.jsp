...
<body>
	<div id="hongdae" class="mx-auto mt-3">
		<div class="representative">
			<img src="<%=ctxPath%>/images/img_hj/store/igloo_byeollae.jpg" alt="...">
		</div>
		...
		<div class="details_location mt-5">
        	<div data-viewid="basicInfoTitle" data-root="" class="place_details" style="display: block;">
    			...
    			<h2 class="tit_location mt-2 mb-3">이글루 별내점</h2>
    			...
    			<div class="details_contactinfo">
        			...
        			<ul class="list_infolocation row">
                		<li class="col-4">
		                    ...
		                    <span>주소 : 경기 구리시 산마루로 19 진영트윈타워주차장 A동</span>
                		</li>
                		<li class="col-4">
		                	<i class="fa-solid fa-phone"></i>
		                    <span>전화번호 : 031-333-3333</span>
                		</li>
            			<li class="col-4">
