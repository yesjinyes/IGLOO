...
<div class="container" style="margin-top: 7%;">
	...
	<div id="allWrap" style="border: solid 1px green;">
			...
			<c:if test="${not empty requestScope.tasteList}">
				<div class="resultDiv">
					...
					<c:if test="${requestScope.tasteList_size > 3}">
						<div align="right" class="more" id="tasteSearchMore" onclick="moreTaste()">검색 결과 더보기</div>
					</c:if>
				</div>
			</c:if>
			...
			<c:if test="${not empty requestScope.productList}">
				<div class="resultDiv">
					...
					<c:if test="${requestScope.productList_size > 3}">
						<div align="right" class="more" id="productSearchMore" onclick="moreProduct()">검색 결과 더보기</div>
					</c:if>
				</div>
			</c:if>
		</div>
			...
			<c:if test="${not empty requestScope.faqList}">
				<div class="resultDiv">
					...
					<c:if test="${requestScope.faqList_size > 3}">
						<div align="right" class="more" id="faqSearchMore" onclick="moreFaq()">검색 결과 더보기</div>
					</c:if>
				</div>
			</c:if>
		</div>
