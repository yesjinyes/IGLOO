...
$(document).ready(function() {
   ...
   IMP.init('imp33116471');  // 중요!!  아임포트에 가입시 부여받은 "가맹점 식별코드". 
   ...
   IMP.request_pay({
       ...
       amount : ${requestScope.totalprice},	  // '${coinmoney}'  결제 금액 number 타입. 필수항목. 넘버타입이라서 따옴표 빼도됨 
	   ...
	   */
		...
		*/
		...
		<%-- $(opener.location).attr("href", "javascript:goCoinUpdate('<%= ctxPath%>', '${requestScope.userid}','${requestScope.coinmoney}')"; --%>
            ...
            location.href="/IGLOO";
            alert("결제에 실패하였습니다. 아이스크림에 가치를 더하다. -IGLOO- ");
       }
