...
<div class="container contents">
  ...
  <form name="orderDetailFrm">
	...
	<div id="imgdiv" class="row">
		<img src="<%= ctxPath%>/images/img_yejin/cup_size/${requestScope.productimg}" class="card-img-top" style="width: 300px; height: 350px;" alt="사진경로잘못됨">
	</div>
	...
	<div id="item_detail">
		<div class="p-0  my-auto">
			...
			<h6 style="font-size: 27pt; text-align: right;">${requestScope.productprice}</h6>
		</div>
